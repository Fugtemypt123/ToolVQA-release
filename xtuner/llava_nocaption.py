...
# Data
data_root = 'data/'
data_path = data_root + 'train/train_data_vlm_21105_nocaption.json'
image_folder = ''
prompt_template = PROMPT_TEMPLATE.llama3_chat
max_length = int(3072 - (336 / 14)**2) # int(2048 - (336 / 14)**2)

# Scheduler & Optimizer
batch_size = 2  # per_device
accumulative_counts = 128
dataloader_num_workers = 0
max_epochs = 2 # epoch=5, iter=6400
optim_type = AdamW
lr = 2e-4
betas = (0.9, 0.999)
weight_decay = 0
...
evaluation_images = 'data/test/test_data_vlm_50.json'
evaluation_inputs = 'data/test/test_data_vlm_50.json'
