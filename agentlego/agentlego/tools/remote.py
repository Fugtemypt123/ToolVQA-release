...
class RemoteTool(BaseTool):
    ...
    def apply(self, *args, **kwargs):
        ...
        } # {'url': 'http://0.0.0.0:16181/OCR', 'params': {}, 'files': {'image': ('image', <_io.BufferedReader name='/network_space/server126/shared/yinshaofeng/ToolLLM/GTA/datasets/Pubtabnet/pubtabnet/train/PMC5683519_004_00.png'>), 'lang': (None, 'eng')}}
        ...
        try:
            ...
            if 'files' in request_args:
                if 'image' in request_args['files']:
                    f = request_args['files']['image'][1]
                    f.close()
